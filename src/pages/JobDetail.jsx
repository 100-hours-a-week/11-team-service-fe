...
const JobDetail = () => {
    ...
    if (loading) return <div className="p-4 flex justify-center pt-20"><div className="animate-spin rounded-full h-8 w-8 border-b-2 border-gray-900"></div></div>;
    if (!job) return <div className="p-4 text-center pt-20">공고를 찾을 수 없습니다.</div>;

    const startDate = job.startDate ? job.startDate.replaceAll('-', '.') : 'YYYY.MM.DD';
            ...
            <div className="p-5">
                ...
                <div className="grid grid-cols-2 gap-y-6 gap-x-4 mb-8">
                    ...
                    <div className="col-span-1">
                        ...
                        <div className="bg-gray-100 rounded-lg px-3 py-2 text-sm font-medium text-gray-900 h-full flex items-center">
                            ...
                            <span className="line-clamp-2">
                                {job.mainTasks && job.mainTasks.length > 0 ? job.mainTasks.join(', ') : '-'}
                            </span>
                        </div>
                    </div>
                    {/* Tech Stack */}
                    ...
                    <div>
                        ...
                        <div className={`rounded-lg px-3 py-2 text-sm font-bold inline-block
