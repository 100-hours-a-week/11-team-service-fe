...
const MyApplications = () => {
    ...
    const getStatusLabel = (status) => {
        ...
        switch (status) {
            case "ACTIVE":
                return { text: "지원완료", className: "bg-blue-50 text-blue-600 border-blue-100" };
            case "PASSED":
                return { text: "서류합격", className: "bg-green-50 text-green-600 border-green-100" };
            case "REJECTED":
                return { text: "불합격", className: "bg-red-50 text-red-600 border-red-100" };
            default:
                return null;
        }
    };
            ...
            <div className="sticky top-0 bg-white z-20 border-b border-gray-100">
                <div className="flex items-center justify-between px-4 h-14">
                    <div className="flex items-center">
                        <h1 className="font-bold text-gray-900 text-lg tracking-tight">이력 관리</h1>
                    </div>
                </div>
            </div>
                ...
                {loading ? (
                    ...
                    <div className="flex flex-col items-center justify-center min-h-[400px] text-center p-8">
                        ...
                        <h3 className="text-gray-900 font-bold mb-1">
                            {debouncedKeyword ? "검색 결과가 없습니다" : "지원 내역이 없습니다"}
                        </h3>
